...
public class MainActivity extends AppCompatActivity {
    ...
    private NodeConfig createTestnetConfiguration() {
        ...
        try {
            ...
            //nodes.
            //Geth.foundationBootnodes()
            //config.setBootstrapNodes(Geth.foundationBootnodes());
           // Geth.
            //config.setEthereumTestnetNonces(config.getEthereumTestnetNonces());
    ...
    public void sendMessage(View view) {
        ...
        try {
            ...
            showresult.append("Cost Of Ether: " + myInt.toString());
        }catch (Exception e) {
            e.printStackTrace();
        }
    }
